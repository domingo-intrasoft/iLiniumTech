...
| `tests/e2e/domain-fixtures.smoke.e2e.ts` | `/agenda`, `/propuestas`, `/recibos`, `/suplementos`, `/siniestros`, `/liq-cia`, `/liq-col` | Paginas de dominio fixture read-only, filtro local, limpieza y ausencia de backend/leaks. |
