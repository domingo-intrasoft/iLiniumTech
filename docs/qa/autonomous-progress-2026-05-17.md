...
Validacion adicional tras `caption` accesible de tabla de Polizas:

- `npx vitest run src/features/polizas/PolizasTable.test.ts`: `6/6` tests OK.
- `npm run format`: OK.
- `npm run lint`: OK.
- `npm run test:unit`: `194/194` tests OK.
- `npm run build`: OK.
...
Validacion adicional tras descripcion accesible del enlace de vuelta del detalle:
...
Validacion adicional tras descripcion accesible de acciones bloqueadas en Siniestros:

- `npx vitest run src/features/siniestros/SiniestrosView.test.ts`: `2/2` tests OK.
- `npm run format`: OK.
- `npm run lint`: OK.
- `npm run test:unit`: `195/195` tests OK.
- `npm run build`: OK.
