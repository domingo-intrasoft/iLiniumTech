...
| --- | --- | --- | --- | --- | --- | --- |
| Agenda | Ruta protegida `fixture`; Vue read-only con filtros locales y acciones bloqueadas. | `frontend-agenda-static-readiness-polish`; SDD draft: [`SDD-2026-011`](../../sdd/specs/iLiniumTech/SDD-2026-011-agenda-read-only.md). | Listado real por rango; calendario visual, detalle, descripcion larga, participantes, drag/drop, reprogramacion, exportacion y escrituras quedan para SDD posterior. | `iLiniumTech.Frontend/src/features/agenda/**`, `docs/qa/agenda-mvp-evidence.md`. | Backend, `src/services/**`, router, navegacion, extractor, package files. | Frontend format/lint/unit/build si toca UI; baseline docs si toca docs. |
...
| Propuestas | Ruta protegida `fixture`; alcance real no confirmado; SDD draft: [`SDD-2026-012`](../../sdd/specs/iLiniumTech/SDD-2026-012-propuestas-read-only.md). | `frontend-propuestas-static-scope-clarity`. | Listado real minimizado; detalle, emision, conversion a poliza, documentos, importes, tarificacion, integraciones y workflow quedan para SDD posterior. | `iLiniumTech.Frontend/src/features/propuestas/**`, `docs/qa/propuestas-mvp-evidence.md`. | Backend, servicios API, permisos nuevos, deducciones de `Solicitudes`. | Frontend completo si UI; baseline docs si documentacion. |
...
| Suplementos | Ruta protegida `fixture`; workflows y adjuntos bloqueados; SDD draft: [`SDD-2026-013`](../../sdd/specs/iLiniumTech/SDD-2026-013-suplementos-read-only.md). | `frontend-suplementos-static-readiness-polish`. | Listado real minimizado; detalle, alta/edicion, documentos, importes, banco, workflows, exportacion y relaciones quedan para SDD posterior. | `iLiniumTech.Frontend/src/features/suplementos/**`, `docs/appbuilder/pages/suplementos/**`, `docs/qa/**`. | Backend, servicios API, workflows heredados, metadata runtime. | Frontend completo si UI; secret scan si se documentan adjuntos/entornos. |
