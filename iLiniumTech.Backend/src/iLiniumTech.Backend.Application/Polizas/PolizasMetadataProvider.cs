    ...
    public static PolizasComponentMetadata Create() =>
        new(
            ...
            [
                ...
                new("tipoPoliza", "IdTipoPoliza", "Tipo poliza", "string", true, true, false, 5),
                new("documento", "NumDocumento", "Documento", "string", true, false, false, 6),
                new("ramo", "IdRamo", "Ramo", "string", true, true, true, 9),
                new("riesgo", "Riesgo", "Riesgo", "string", false, false, false, 10),
                ...
                new("clienteNombre", "NombreCompleto", "Cliente", "string", true, true, true, 40),
