...
- `iLiniumTech.Backend`: API .NET con capas `Api`, `Application`, `Domain` e `Infrastructure`.
...
- Lee `README.md`, `docs/engineering/README.md`, `docs/PLAN_CICD_GITHUB_ONLY.md`, `docs/MVP_POLIZAS_PLAN.md`, `docs/MVP_POLIZAS_DIFERENCIAS.md` y la SDD relacionada antes de cambiar comportamiento.
...
## Flujo WorkItem/PR solicitado por usuario

En este proyecto, cuando el usuario pida crear un WorkItem/PR:

- Usar `master` como rama base por defecto, al ser la rama principal de este repo.
- No implementar todavia.
- Crear WorkItem con el titulo indicado.
- Crear rama `codex/wi-<slug>`.
- Crear worktree en `C:\Desarrollo\CodexWorktrees\iLiniumTech-<slug>`.
- Crear PR draft hacia `master`.
- Trabajar siempre en el worktree, nunca en el repo principal.
- Devolver WI, PR, rama, worktree y nombre sugerido del hilo.
...
- No hacer push directo a la rama principal.
