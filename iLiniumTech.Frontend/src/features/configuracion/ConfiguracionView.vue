...
const tableCaption = computed(
  () =>
    `Configuracion fixture read-only: ${firstVisible.value}-${lastVisible.value} de ${total.value} ${resultLabel.value}. Superficie sensible sin secretos, valores reales ni API backend.`,
)
