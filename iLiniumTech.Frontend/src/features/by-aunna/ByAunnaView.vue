...
const tableCaption = computed(
  () =>
    `By Aunna fixture read-only: ${firstVisible.value}-${lastVisible.value} de ${total.value} ${resultLabel.value}. Contenido demo sin enlaces reales, publicacion ni API backend.`,
)
