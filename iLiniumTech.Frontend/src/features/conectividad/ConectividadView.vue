...
const tableCaption = computed(
  () =>
    `Conectividad fixture read-only: ${firstVisible.value}-${lastVisible.value} de ${total.value} ${resultLabel.value}. Sin endpoints reales, secretos, llamadas externas ni API backend.`,
)
