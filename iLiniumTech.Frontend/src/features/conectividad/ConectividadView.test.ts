...
describe('ConectividadView', () => {
  it('renders the sensitive static Conectividad surface without runtime markers', () => {
    const wrapper = mountView()

    expect(wrapper.get('h1').text()).toBe('Conectividad')
    expect(wrapper.text()).toContain('ejecuta pruebas de integracion')
